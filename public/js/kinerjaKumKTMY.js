...
async function getKumEFORY(req) {
  const arrdmfoud = [];
  const arrdmfoshdrsh = [];
...
module.exports = { getKumEAFY, getKumEFORY, getKumSOFY, getKumPSY, getKumSFCY };
