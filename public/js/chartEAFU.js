      ...
      datasets: [
        {
          ...
          borderColor: ["rgba(10, 187, 249)", "rgba(0, 187, 249)", "rgba(0, 187, 249)", "rgba(0, 187, 249)", "rgba(0, 187, 249)", "rgba(0, 187, 249)"],
          tension: 0.1,
          borderWidth: 2.5,
        },
        {
          ...
          borderColor: ["rgba(10, 245, 212)", "rgba(0, 245, 212)", "rgba(0, 245, 212)", "rgba(0, 245, 212)", "rgba(0, 245, 212)", "rgba(0, 245, 212)"],
          tension: 0.1,
          borderWidth: 2.5,
        },
        {
          ...
          borderColor: ["rgba(1254, 228, 64)", "rgba(254, 228, 64)", "rgba(254, 228, 64)", "rgba(254, 228, 64)", "rgba(254, 228, 64)", "rgba(254, 228, 64)"],
          tension: 0.1,
          borderWidth: 2.5,
        },
      ],
